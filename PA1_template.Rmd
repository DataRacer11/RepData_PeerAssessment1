...
- No, the mean of total values do not differ the from the estimates from the first part of the assignment.

### What is the impact of imputing missing data on the estimates of the total daily number of steps?

- The original averages for each day that did not show as NA remain unchanged.
- The overall values may show to be slightly higher with a more rigid and more sophisticated strategy however as a cursory look though the 
.csv file.
- A quick exploratory analysis of plotting the days (many plots not included in this document) showed the imputed days that were missing tended to be Wednesdays, and Thursday through Friday of the week.
- These days appear to have increased steps activity.
...
## Are there differences in activity patterns between weekdays and weekends?
>>>>>>> 79f6809366a01db33783c0858cefe47c50d4de38
